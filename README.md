...
<!-- COVID_CHART_START -->
<p align="center">
  <img src="docs/chart_preview.png?v=20260907" width="900" alt="SARS-CoV-2 weekly ILI positivity rate (5-week moving average)"/>
  <br/>
  <em>SARS-CoV-2 weekly ILI positivity rate at sentinel hospitals — <strong>5-week moving average</strong> (CDC sentinel convention). Latest week: 2026-09-07.</em>
</p>
<!-- COVID_CHART_END -->
